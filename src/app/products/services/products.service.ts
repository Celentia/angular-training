...
export class ProductsService {
  ...
  getProducts(): ProductModel[] {
    return [
      ...
      { name: 'Chinese Sencha', description: "This Chinese Sencha is a distinctive green tea that reflects its Japanese processing and Chinese terroir. The leaves are Long with a crisp dryness and grassy yet subtly floral scent.", price: 79, category: Сategory.Green, isAvailable: false },
